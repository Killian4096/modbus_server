...
uint8_t modbus_slave_data_buffer_LRC_check(const struct modbus_slave_data_buffer_t*);
void modbus_slave_data_buffer_LRC_gen(struct modbus_slave_data_buffer_t*);
